...
for r in results:
    ...
    params[4] = max(0, (r[0] * ingredients[0].calories) + (r[1] * ingredients[1].calories) + (r[2] * ingredients[2].calories) + (r[3] * ingredients[3].calories))

    scores.append([params[0] * params[1] * params[2] * params[3], params[4]])

#print scores
highestScore = scores[0]
for s in scores:
    if s[0] > highestScore[0] and s[1] == 500:
        highestScore = s
